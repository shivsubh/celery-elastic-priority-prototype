...
@gevent_safe(reason="Triggers lightweight task delegation")
...
@gevent_safe(reason="Fast checking algorithm usually non-blocking")
...
@blocking(reason="Database object validation and creation")
