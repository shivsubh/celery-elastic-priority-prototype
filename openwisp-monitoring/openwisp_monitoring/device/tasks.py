...
from ..celery_utils import gevent_safe, blocking
...
@gevent_safe(reason="Dispatching logic without heavy processing")
...
@shared_task(base=OpenwispCeleryTask)
@gevent_safe(reason="Dispatch wrapper")
...
@shared_task(base=OpenwispCeleryTask)
@blocking(reason="Massive DB deletes")
...
@shared_task(base=OpenwispCeleryTask)
@blocking(reason="Closing multiple models")
...
@shared_task(base=OpenwispCeleryTask)
@gevent_safe(reason="Fast writer dispatch")
...
@shared_task(base=OpenwispCeleryTask)
@blocking(reason="Organization wide disable cascading")
